...
package net.semanticmetadata.lire.imageanalysis.features.global.dcm;
...
public class DcmDump implements DicomInputHandler {
    ...
    private static ResourceBundle rb =
        ResourceBundle.getBundle("dcmdump.messages");
    ...
    public void readValue(DicomInputStream dis, Attributes attrs)
        ...
        if (vr.prompt(b, dis.bigEndian(),
            ...
            line.append(']');
            map.put(ElementDictionary.keywordOf(dis.tag(), null), builder.toString());
            appendKeyword(dis, line);
        }
        //System.out.println(line);
